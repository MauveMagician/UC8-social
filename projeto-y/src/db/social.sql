...
CREATE TABLE posts(post_id INT PRIMARY KEY auto_increment, user_id INT, content VARCHAR(140),posts_date DATETIME, FOREIGN KEY (user_id) REFERENCES users(user_id));
